...
class BaseAdapter(ABC):
    ...
    WEBHOOK_PATH: str = ""
    # Adapter-scoped configuration. Each adapter declares its own params
    # ({param: [description, default]}); the gateway aggregates them rather
    # than hardcoding channel-specific keys.
